...
import { usePictureInPicture } from '~/components/ui/PictureInPicture';
...
export const Workbench = memo(
  ({ chatStarted, isStreaming, metadata, updateChatMestaData, setSelectedElement }: WorkspaceProps) => {
    ...
    const { PictureInPicture, isOpen: isPipOpen, open: openPip, close: closePip } = usePictureInPicture();
              ...
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  ...
                  {selectedView === 'preview' && (
                    ...
                    >
                      <div className="i-ph:picture-in-picture" />
                      Picture-in-Picture
                    </PanelHeaderButton>
                  )}
