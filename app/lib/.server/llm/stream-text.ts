...
export async function streamText(props: {
  ...
  // Apply agent-specific prompt enhancement
...
You are currently operating as the ${agent.name}. Focus your expertise on: ${agent.capabilities.join(', ')}.
Prioritize solutions that align with your specialized knowledge in: ${agent.expertise.join(', ')}.
